...
parse: clike_structures.a clike_funcs.o clike.tab.o clike.lex.o  
	gcc -Wall ${FLAGS} clike_funcs.o clike_structures.a clike.lex.o -lfl -o $@ clike.tab.o
...
# parse: clike.y clike.h clike.l
# 	bison -dv clike.y --report=solved
# 	flex -o clike.lex.c clike.l
# 	gcc -Wall ${FLAGS} clike_funcs.c clike.lex.c -lfl -o $@ clike.tab.c 

# .PHONY: clean

# clean:
# 	rm -f parse *.lex.c *.tab.c *.tab.h *.output
