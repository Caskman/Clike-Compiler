...
parse: clike_funcs.c clike.tab.c clike.lex.c stringksymvhashtable.c typelist.c stringlist.c symlist.c exprlist.c stmtlist.c quadlistlist.c quadlist.c stringkstringvhashtable.c
	gcc -Wall ${FLAGS} clike_funcs.c clike.lex.c -lfl -o $@ clike.tab.c stringksymvhashtable.c stringksymventrylist.c typelist.c stringlist.c symlist.c exprlist.c stmtlist.c quadlistlist.c quadlist.c stringkstringvhashtable.c
